...
public class UVMKPSPublicSoap
{
    ...
    public UVMKPSPublicSoap(){}

    public UVMKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public UVMKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        UVMExtendedSoapSerializationEnvelope envelope= new UVMExtendedSoapSerializationEnvelope(UVMExtendedSoapSerializationEnvelope.VER11);
