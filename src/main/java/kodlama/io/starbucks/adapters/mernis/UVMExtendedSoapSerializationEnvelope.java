...
class UVMSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class UVMExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(UVMDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new UVMStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static UVMDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static UVMDateTimeConverter dateTimeConverter = new UVMStandardDateTimeConverter();

    public UVMExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public UVMExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new UVMMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=UVMHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,UVMExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=UVMHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
